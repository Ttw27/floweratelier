    ...
    <div className="pt-28 pb-20 bg-[#FAFAF7]" data-testid="privacy-page">
      <div className="max-w-3xl mx-auto px-6 md:px-8">
        ...
        <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A]/90 leading-relaxed space-y-6 text-[15px]">
          <p>
            Petals Atelier (&ldquo;we&rdquo;, &ldquo;us&rdquo;) is the data controller of any personal information you provide. We comply
          ...
          <p>
            ...
            Email <a className="underline" href="mailto:atelier@petalsatelier.com">atelier@petalsatelier.com</a> to exercise these rights.
          </p>
