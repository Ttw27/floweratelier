...
export default function AdminPage() {
  ...
  if (authLoading || loading) return <div className="min-h-screen flex items-center justify-center pt-20"><div className="spinner" /></div>;
  if (!user || !user.is_admin) return null;

  return (
    <div className="min-h-screen pt-20 py-12" data-testid="admin-page">
