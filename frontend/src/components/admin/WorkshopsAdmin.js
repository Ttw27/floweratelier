            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {editingWorkshop.booking_mode === "enquire" && (
                <>
                  ...
                  <div className="md:col-span-2"><Field label="WhatsApp pre-filled message"><Input value={editingWorkshop.whatsapp_message} onChange={(e) => setEditingWorkshop({ ...editingWorkshop, whatsapp_message: e.target.value })} placeholder="Hello Flower Atelier — I'd like to enquire about…" className="light-input rounded-none" /></Field></div>
                </>
              )}
